...
if(train_mode == 'opencv'):
    ...
    recognizer.write(test_name + '/'+test_name+'/trainer/trainer.yml') # recognizer.save() worked on Mac, but not on Pi
else:
    ...
    history = cnn.fit(train_generator, epochs=20, validation_data=test_generator, shuffle=True, validation_steps=len(y_test))
